...
class SPMDataProcessor:
    ...
    def parse_local_arguments(self):
        ...
        parser.add_argument('--config_path', type=str, default='scripts/edh_pipelib/head-snapshot/master/lib/data_ingestion/spm/config/prod/sys_user.yaml')
        parser.add_argument('--scripts_bucket', type=str, default='baxaws-prd-enterpriseanalytics-edh-ita-inbound')
        parser.add_argument('--scripts_target_bucket', type=str, default='baxaws-prd-enterpriseanalytics-ita-translate')
