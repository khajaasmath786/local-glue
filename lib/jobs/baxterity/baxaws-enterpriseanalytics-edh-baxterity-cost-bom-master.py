...
class AthenaQueryExecutor:
    ...
    def query_metadata(self):
        ...
        query = """
        select max(start_time) from baxmfgdpl.lth_job_audit where job_name = 'baxaws-enterpriseanalytics-edh-baxterity-cost-bom-master' and job_status = 'SUCCESS'
        """
    ...
    def execute_query_p_jde_wo_lbr_abspn_rpt(self):
        ...
        q = (''' SELECT
                    ...
                    CO_BY_INTRMD_CD,
                    SCD_EXPN_DTM
                    FROM enterpriseanalytics_edh_trnslt_gme.p_jde_bom_mstr
                    WHERE  BOM_TYP_CD = 'SC' and BU_CD = '%s' and SCD_CUR_IND = 'Y'
                    and ETL_UPDT_DTM >= '%s' 
