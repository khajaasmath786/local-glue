...
python3 run.py s3://baxaws-tst-enterpriseanalytics-edh-jde-inbound/scripts/edh_pipelib/conf/dp_sop_tochar_view.json

./run_sop.sh s3://baxaws-tst-enterpriseanalytics-edh-jde-inbound/scripts/edh_pipelib/configs/dp_apps/dp_sop.json

python3 run.py  s3://baxaws-tst-enterpriseanalytics-edh-jde-inbound/scripts/edh_pipelib/configs/dp_apps/dp_sop_create_table_view.json
